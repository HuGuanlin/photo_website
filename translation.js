(function () {
  ...
  const translations = {
    en: {
      ...
      projectPageTitleWithName: '{name} | Project Gallery',
    ...
    de: {
      ...
      projectPageTitleWithName: '{name} | Projektgalerie',
    ...
    zh: {
      homeTitle: '摄影作品集',
      homeDescription: '胡的摄影作品集。',
      projectPageTitle: '项目画廊',
      projectPageTitleWithName: '{name}｜项目画廊',
      projectPageDescription: '胡的摄影项目画廊。',
      AboutText: '简介',
      closeAbout: '关闭简介面板',
      closePreview: '关闭预览',
      profileAlt: '头像',
